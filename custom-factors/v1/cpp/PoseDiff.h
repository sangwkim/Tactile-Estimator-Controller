...
class PoseDiff: public gtsam::NoiseModelFactor3<gtsam::Pose3, gtsam::Pose3, gtsam::Pose3> {
...
public:
  ...
  PoseDiff(gtsam::Key key1, gtsam::Key key2, gtsam::Key key3, gtsam::SharedNoiseModel model, bool zeroJac) :
