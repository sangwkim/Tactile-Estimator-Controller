/*
Computes the penetration length (pcnocz)
Then encourage this length to be larger than the threshold (epsilon_)
*/
...
class PenHinge: public gtsam::NoiseModelFactor3<gtsam::Pose3, gtsam::Pose3, gtsam::Pose3> {
...
public:
  ...
  PenHinge(gtsam::Key key1, gtsam::Key key2, gtsam::Key key3, double cost_sigma, double eps) :
