// Squared Norm of this factor is the energy due to the elastic deformation of the sensor
...
class EnergyElastic: public gtsam::NoiseModelFactor2<gtsam::Vector6, gtsam::Vector9> {

public:

  EnergyElastic(gtsam::Key key1, gtsam::Key key2, double cost_sigma) :
